...
<p>{У вас имеется незаконченный заказ}.</p>

<p>{Подробности заказа} от @date@</p>
<p>{Заказанные товары}</p>
<hr><p>
@cart@</p>
<hr>
<p>
{Итого} -- @sum@ @currency@</p>
<hr>
<br>         
<hr>
<p>{Для продолжения оформления заказа перейдите пожалуйста по ссылке} "<a href='http://@serverPath@/order/'>{Оформить заказ сейчас}</a>".
</p>  
        </td>
    </tr>
