...
$TitlePage = __('Создание новой компании');
...
function actionStart() {
    ...
    $Tab1.= $PHPShopGUI->setField('UTM-метка', $PHPShopGUI->setInputText('utm_campaign=', 'utm_new', $data['utm']));
    ...
    $Tab1.=$PHPShopGUI->setField('Описание', $PHPShopGUI->setTextarea('content_new',$data['content']));
