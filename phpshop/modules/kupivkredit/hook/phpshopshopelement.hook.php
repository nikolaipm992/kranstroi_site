...
function product_grid_kvk_element_hook($obj, $dataArray) {
    ...
    if ($price >= 3000 && $dataArray['kvk_enabled'] == 1) {
        ...
        $dis = ParseTemplateReturn($GLOBALS['SysValue']['templates']['kupivkredit']['kupivkredit_grid'], true);
    }

    $obj->set('kvk_product_grid', $dis);

}

$addHandler = array
(
    'product_grid' => 'product_grid_kvk_element_hook',
);
