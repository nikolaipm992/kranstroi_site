                        ...
                        <tbody>
                            ...
                            <tr>
                                <td bgcolor="#f3f3f3" align="center" height="60"
                                    style="font-size: 18px; color: #464646; font-weight: 700; background: #f3f3f3; border-radius:4px;font-family:    Helvetica, sans-serif; letter-spacing: 1px; ">{Активируйте нового пользователя} @user_name@
	                            </td>
                            </tr>
