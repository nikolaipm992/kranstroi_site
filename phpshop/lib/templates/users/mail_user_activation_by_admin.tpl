    ...
    <table class="full-width" bgcolor="#f3f3f3" style="background: #f3f3f3; width: 100%; " width="100%" cellspacing="0"
        ...
        <tbody width="100%" style="width: 100%; " align="center">
            ...
            <tr>
             ...
             <p>{Пожалуйста, подождите уведомления об активации от администратора сайта. Активация выполняется в ручном режиме, это может занять некоторое время. После активации, Вам будут доступны дополнительные возможности работы с интернет-магазином}.</p>                                </td>
                            </tr>
                        </tbody>
                    </table>
                    <table class="full" align="center"
