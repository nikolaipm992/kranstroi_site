...
function actionStart() {
    ...
    if (!empty($json_data['data']) and is_array($json_data['data'])) {
        ...
        $PHPShopInterface->setRow(__('Итого и средние'), array('name'=>$json_data['totals'][0],'align'=>'center'), array('name'=>$json_data['totals'][1],'align'=>'center'), array('name'=>$json_data['totals'][2],'align'=>'center'));
