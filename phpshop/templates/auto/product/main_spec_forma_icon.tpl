<div class="col-sm-3 col-lg-3 px-2 px-sm-3 mb-3 mb-sm-5">
    ...
    <div class="card card-bordered shadow-none text-center h-100">
        ...
        <div class="card-footer border-0 pt-0 pb-4 px-4">
            ...
            <button type="button" class="btn btn-sm btn-outline-primary btn-pill transition-3d-hover addToCartList @elementCartHide@ @hideCatalog@" data-uid="@productUid@">@productSale@</button>
        </div>
    </div>
    <!-- End Product -->
</div>