<div class="col-auto col-sm-4 col-lg-3 px-2 px-sm-2 mb-2 mb-sm-2">
    ...
    <div class="card shadow-soft transition-3d-hover text-center h-100" style="min-height:440px;">
        ...
        <a class="btn btn-sm btn btn-soft-primary @elementCartOptionHide@ @hideCatalog@" href="/shop/UID_@productUid@.html">@productSale@</a>
        <button type="button" class="btn btn-sm btn btn-soft-primary addToCartList @elementCartHide@ @hideCatalog@" data-uid="@productUid@">@productSale@</button>
    </div> 
    <!-- End Product -->
</div>