                ...
                <div class="mr-2 col-lg-12">
                    ...
                    <ul class="nav nav-segment float-right" id="filter-wel-stat">
                        <li class="list-inline-item">
                            <a class="nav-link @gridSetAactive@" href="?gridChange=1" data-toggle="tooltip" data-placement="top" name="gridChange" value="1">
                                <i class="fas fa-list"></i>
                            </a>
                        </li>
                        <li class="list-inline-item ">
                            <a class="nav-link @gridSetBactive@" href="?gridChange=2" data-toggle="tooltip" data-placement="top"  name="gridChange" value="2">
