<div class="col-md-3 col-sm-3 col-xs-6 product-block-wrapper-fix">
    <div class="thumbnail">
        ...
        <div class="product-btn @hideCatalog@"> <button class=" addToCompareList " data-uid="@productUid@"><span class="icons icons-green icons-small icons-compare"></span></button>
